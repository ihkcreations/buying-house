            ...
            <Table className="min-w-[1000px] w-full">
              <TableHeader>
                <TableRow className="bg-slate-50 border-b border-slate-200">
                  <TableHead className="w-[100px] sticky left-0 z-20 bg-slate-50 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] font-bold text-slate-900">Order No</TableHead>
                  
            
                  {/* MATRIX COLUMNS */}
                  <TableHead className="text-center font-bold w-[50px] min-w-[50px]">PO</TableHead>
                  <TableHead className="text-center font-bold w-[50px] min-w-[50px]">PI</TableHead>
                    <TableHead className="text-center font-bold w-[50px] min-w-[50px]">SC</TableHead>
                    <TableHead className="text-center font-bold w-[50px] min-w-[50px]">L/C</TableHead>
                    <TableHead className="text-center font-bold w-[50px] min-w-[50px]">UD</TableHead>
                    <TableHead className="text-center font-bold w-[50px] min-w-[50px]">Pack</TableHead>
                    <TableHead className="text-center font-bold w-[50px] min-w-[50px]">Inv</TableHead>
                    <TableHead className="text-center font-bold w-[50px] min-w-[50px]">D.BL</TableHead>
                    <TableHead className="text-center font-bold w-[50px] min-w-[50px]">O.BL</TableHead>
                    <TableHead className="text-center font-bold w-[50px] min-w-[50px]">GSP</TableHead>
                  <TableHead className="w-[180px] font-bold text-slate-700">Buyer</TableHead>
            
                  <TableHead className="text-right sticky right-0 z-20 bg-slate-50 shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.1)]">Action</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {orders.length === 0 ? (
